  ...
  EN: {
    ...
    slides: [
      ...
      },
      {
        ...
        title: 'Ask / next step',
        body: [
          'Prova is seeking funding via Solana Foundation Grants or other programs across the Solana ecosystem to accelerate commercial validation and, eventually, the Mainnet migration — not just a green light, but concrete runway. It fits the product\'s real state: a technical MVP already live on Devnet, 2 design partners with real integration evidence, and a decision already made to wait for the first real LOI before moving Mainnet\'s timing — funding is what sustains that runway while that validation arrives.',
        ],
      },
    ],
